            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6  order-0 order-md-1 ">
                        <img src="assets/img/deversh/Gastroenterology (1).png" class="img-fluid  need_img_top" alt="">
                    </div>
        ...
        <section>
            ...
            <div class="container  need_cont_spacew">
                <div class="row ">
                    ...
                    <div class="col-md-6 ">
                        <div class=" ">
                            <img src="assets/img/deversh/Gastroenterology (2).png" class="img-fluid   " alt="">
                        </div>
                    </div>
