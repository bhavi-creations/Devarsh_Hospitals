            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6  order-0 order-md-1 ">
                        <img src="assets/img/deversh/orthopedics (1).png" class="img-fluid  need_img_top" alt="">
                    </div>
        ...
        <section>
            ...
            <div class="container  need_cont_spacew">
                <div class="row ">
                    ...
                    <div class="col-md-6 ">
                        <div class=" ">
                            <img src="assets/img/deversh/orthopedics (2).png" class="img-fluid   " alt="">
                        </div>
                    </div>
                        ...
                        <div class="faq">
                            <ul class="faq-list">
                                <li class="padding_in_list">
                                    <div class="question ">
                                        <p class="list_p_tag">How long does it take to recover from orthopaedic surgery?
                                ...
                                <li>
                                    <div class="question ">
                                        <p class="list_p_tag">Will I be able to do everything I used to do after surgery?
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="faq">
                            <ul class="faq-list">
                                ...
                                <li>
                                    <div class="question ">
                                        <p class="list_p_tag">How long do artificial joints last?
                                ...
                                <li>
                                    <div class="question ">
                                        <p class="list_p_tag"> Is a fracture the same as a sprain?
